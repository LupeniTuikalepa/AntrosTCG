...
public class StylizedSurfaceEditor : BaseShaderGUI {
    ...
    private const string UnityVersion = "NLC6GR";
    ...
    public override void ValidateMaterial(Material material) {
        ...
        // Draw only active outline passes so the renderer can use the SRP Batcher.
        material.SetShaderPassEnabled(OutlinePassName, material.IsKeywordEnabled("DR_OUTLINE_ON"));
        material.SetShaderPassEnabled(LegacyOutlinePassName, false);
#endif
    }
        ...
        foreach (MaterialProperty property in properties) {
            ...
            if (!hideInInspector && !skipProperty) {
                ...
                if (property.name.Equals("_OutlineEnabled")) {
                    ...
                    if (outlineEnabled && _target.GetShaderPassEnabled(LegacyOutlinePassName)) {
                    ...
                    if (_target.GetShaderPassEnabled(LegacyOutlinePassName) && outlineEnabled) {
                        _target.SetShaderPassEnabled(LegacyOutlinePassName, false);
