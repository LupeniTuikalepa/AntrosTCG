...
namespace Helteix.ControlDisplay.Editor.Editor.Editor.Drawers
{
    ...
    public class BindingDisplaySettingsEditor : UnityEditor.Editor
    {
        ...
        public static readonly List<string> SupportedLayouts = new List<string>()
        {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            SerializedProperty compositeProperty = serializedObject.FindBackingFieldProperty(nameof(BindingDisplaySettings.Composites));

            container.Add(new PropertyField(compositeProperty));
